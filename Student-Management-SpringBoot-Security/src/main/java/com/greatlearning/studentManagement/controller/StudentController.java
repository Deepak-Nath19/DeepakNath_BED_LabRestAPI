...
public class StudentController {
	...
	public String showFormForUpdate(@RequestParam(name = "studentId") int id) {
	...
	public ModelAndView accessDenied(Principal user) {
		...
		result.addObject("msg", "Hi " + user.getName() + " does not have authorization");
		result.setViewName("403");
		return result;
	}
